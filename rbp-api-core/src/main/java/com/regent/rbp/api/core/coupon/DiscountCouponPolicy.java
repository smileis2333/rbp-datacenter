 ...
 */
@Data
@ApiModel(description = "折扣券政策")
@EqualsAndHashCode(callSuper = false)
@TableName(value = "rbp_discount_coupon_policy")
public class DiscountCouponPolicy extends Model<DiscountCouponPolicy> {
    ...
    @ApiModelProperty(notes = "是否还原吊牌价")
    private Integer restoreTagPrice;
    @ApiModelProperty(notes = "使用折扣下限")
    private Integer useDiscountMinimum;
