...
import com.regent.rbp.api.core.salesOrder.EmployeeBillAchievement;
import com.regent.rbp.api.core.salesOrder.EmployeeGoodsAchievement;
...
import com.regent.rbp.api.dao.salesOrder.EmployeeBillAchievementDao;
import com.regent.rbp.api.dao.salesOrder.EmployeeGoodsAchievementDao;
...
import com.regent.rbp.api.dto.sale.EmployeeAchievement;
    ...
    private List<String> verificationProperty(SaleOrderSaveParam param, SalesOrderBillSaveContext context) {
        ...
        if (runBarcodeAsGoodInfoSource) {
            ...
            for (SalesOrderBillGoodsResult goodsResult : goodsDetailData) {
                ...
                billGoods.setType(goodsResult.getType());
                billGoods.setSaleModel(goodsResult.getSaleModel());
                billGoods.setAttribute(goodsResult.getAttribute());
                billGoods.setDeliveryMethod(goodsResult.getDeliveryMethod());
                billGoods.setStockModel(goodsResult.getStockModel());
