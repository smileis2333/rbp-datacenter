...
public class LongServiceBean extends ServiceImpl<LongDao, LongInfo> implements LongService {
    ...
    public DataResponse batchCreate(LongSaveParam param) {
        ...
        if (CollUtil.isEmpty(context.getLongNameList())) {
            return new DataResponse(ResponseCode.PARAMS_ERROR, LanguageUtil.getMessage(LanguageUtil.ZH, "dataNotNull", new String[]{LanguageUtil.getMessage("longName")}));
        }
        // 判断内长是否重复
    ...
    public DataResponse batchUpdate(LongUpdateParam param) {
        ...
        if (CollUtil.isEmpty(list)) {
            ...
            return new DataResponse(ResponseCode.PARAMS_ERROR, LanguageUtil.getMessage(LanguageUtil.ZH, "dataNotExist", new String[]{existStr.toString()}));
        }
